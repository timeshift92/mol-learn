namespace $.$$ {
	export type $my_draggableLesson_three_task = {
		id: string
		title: string
	}
	export class $my_draggableLesson_three extends $.$my_draggableLesson_three {
		@ $mol_mem
		task_list( next? : $my_draggableLesson_three_task[] ) {
		...
		task_title( task : $my_draggableLesson_three_task ) {
			return task.title
		}

		@ $mol_mem_key
		task_uri( task : $my_draggableLesson_three_task ) {
		...
		receive_before( anchor : $my_draggableLesson_three_task , task : $my_draggableLesson_three_task ) {
		...
		receive( task : $my_draggableLesson_three_task ) {
		...
		receive_trash( task : $my_draggableLesson_three_task ) {
